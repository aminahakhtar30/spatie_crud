            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    <div>
                        ...
                        <div class="my-3">
                            <input value="{{old('name', $user->name)}}" name="name" placeholder="Enter name" type="text" class="border-gray-300 shabow-sm w-1/2 rounded-lg">
                            @error('name')
                        ...
                        <div class="my-3">
                            <input value="{{old('email', $user->email)}}" name="email" placeholder="Enter email" type="text" class="border-gray-300 shabow-sm w-1/2 rounded-lg">
                            @error('email')
                             <p class="text-red-400 font-medium">{{$message}}</p>
                            @enderror
                        </div>
